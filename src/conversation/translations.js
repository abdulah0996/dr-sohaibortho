const copy = {
  en: {
    ...
    menuReschedule: "🔄 Change Appointment",
    ...
    menuSectionMain: "Clinic Menu",
    menuSectionAppointment: "My Appointment",
    menuFallbackIntro: "Please reply with the number of the option you need:",
    menuFallbackHint: "Reply with a number, for example 1 to book an appointment.",
  ...
  ur: {
    ...
    menuSectionMain: "کلینک مینو",
    menuSectionAppointment: "میری اپائنٹمنٹ",
    menuFallbackIntro: "براہِ کرم مطلوبہ آپشن کا نمبر بھیجیں:",
    menuFallbackHint: "نمبر بھیجیں، مثلاً اپائنٹمنٹ کے لیے 1۔",
